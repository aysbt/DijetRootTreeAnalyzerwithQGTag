...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *qgLDAK4;
   vector<float>   *qgaxis2AK4;
...
void rootNtupleClass::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("qgLDAK4", &qgLDAK4, &b_qgLDAK4);
   fChain->SetBranchAddress("qgaxis2AK4", &qgaxis2AK4, &b_qgaxis2AK4);
