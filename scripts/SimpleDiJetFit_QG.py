...
FunctionType = 0
fileNameSuffix = "RunD_4param_JEC_Summer15_25nsV6_Silver_2445pb-1_plotSig"

####### INPUT #############
# data
input_root_file="histo_data_mjj_fromTree.root"
input_root_file_mc="histo_data_mjj_fromTree.root"
...
def main():
    ...
    chi2 = fitresult[2]
    ndof = fitresult[1]
    DrawFit(g,g_mc, M1Bkg, hist_fit_residual_vsMass, FunctionType, nPar,
...
def doFitAndChi2(FunctionType,hist_mass,g,hist_mass_original):
    ...
    if( FunctionType==0 ):
        ...
        M1Bkg.SetParameter(0, 1.4) # 1.4
        M1Bkg.SetParameter(1, 12) # 12
        M1Bkg.SetParameter(2, 2) # 2
        M1Bkg.SetParameter(3, -0.5) # -0.5
...
def DrawMC(g,g_mc,hist_mass,hist_mc_residual_vsMass,fileNameSuffix):
  ...
  c_mc = TCanvas("c_mc","DijetMass cross section with QCD MC",W,H)
  c_mc.GetWindowHeight()
  c_mc.GetWindowWidth()
  c_mc.SetLogy()
  c_mc.Divide(1,2,0,0,0)
  
  #------------ pad 1  ----------------
  c_mc.cd(1)
  p11_1_mc = c_mc.GetPad(1)
  p11_1_mc.SetPad(0.01,0.23,0.99,0.98)
  p11_1_mc.SetLogy()
  p11_1_mc.SetRightMargin(0.05)
  p11_1_mc.SetTopMargin(0.05)
  p11_1_mc.SetFillColor(0)
  p11_1_mc.SetBorderMode(0)
  p11_1_mc.SetFrameFillStyle(0)
  p11_1_mc.SetFrameBorderMode(0)

  #Pave text
  #pave_fit = TPaveText(0.1558691,0.30735043,0.3750171,0.4070085,"NDC")
  pave_fit_mc = TPaveText(0.2058691,0.1235043,0.4750171,0.2870085,"NDC")
  pave_fit_mc.AddText("Wide Jets")
  pave_fit_mc.AddText("M_{jj} > 1.2 TeV")
  pave_fit_mc.AddText("|#eta| < 2.5, |#Delta#eta| < 1.3")
 
  pave_fit_mc.SetFillColor(0)
  pave_fit_mc.SetLineColor(0)
  pave_fit_mc.SetFillStyle(0)
  pave_fit_mc.SetBorderSize(0)
  pave_fit_mc.SetTextFont(42)
  pave_fit_mc.SetTextSize(0.040)
  pave_fit_mc.SetTextAlign(12) 
  
  vFrame_mc = p11_1_mc.DrawFrame(minX_mass,0.00000005,maxX_mass,5.0)
  vFrame_mc.SetTitle("")
  vFrame_mc.SetXTitle("Dijet Mass [GeV]")
  vFrame_mc.SetYTitle("d#sigma / dm_{jj}   [pb / GeV]")
  vFrame_mc.GetXaxis().SetTitleSize(0.06)
  vFrame_mc.GetXaxis().SetTitleOffset(0.95)
  vFrame_mc.GetXaxis().SetLabelSize(0.05)
  vFrame_mc.GetYaxis().SetTitleSize(0.06)
  vFrame_mc.GetYaxis().SetTitleOffset(0.95)
  vFrame_mc.GetYaxis().SetLabelSize(0.05)
  ...
  leg_mc = TLegend(0.5564991,0.55,0.9203575,0.805812)
  #leg =  TLegend(0.5564991,0.55,0.8903575,0.80)
  leg_mc.SetTextSize(0.03546853)
  leg_mc.SetLineColor(0)
  leg_mc.SetLineStyle(1)
  leg_mc.SetLineWidth(1)
  leg_mc.SetFillColor(0)
  leg_mc.SetFillStyle(0)
  leg_mc.SetMargin(0.35)
  leg_mc.AddEntry(g,"data" ,"PL")
  leg_mc.AddEntry(g_mc,"mc","L")
  leg_mc.Draw("same")
  pave_fit_mc.Draw("same") 
  ...
  p11_1_mc.RedrawAxis()
  p11_1_mc.Update()
  p11_1_mc.GetFrame().Draw()
  #draw the lumi text on the canvas
  CMS_lumi.CMS_lumi(p11_1_mc, iPeriod, iPos)

   #--- Next PAD
  
  c_mc.cd(2)
  p11_2_mc = c.GetPad(2)
  p11_2_mc.SetPad(0.01,0.02,0.99,0.24)
  p11_2_mc.SetBottomMargin(0.35)
  p11_2_mc.SetRightMargin(0.05)
  p11_2_mc.SetGridx()
  p11_2_mc.SetGridy()
 
  vFrame2_mc = p11_2_mc.DrawFrame(p11_1_mc.GetUxmin(), -4.5, p11_1_mc.GetUxmax(), 4.5)
  vFrame2_mc.SetTitle("")
  vFrame2_mc.SetXTitle("Dijet Mass [GeV]")
  vFrame2_mc.GetXaxis().SetTitleSize(0.06)
  vFrame2_mc.SetYTitle("(Data-MC)/#sigma")
  vFrame2_mc.GetYaxis().SetTitleSize(0.15)
  vFrame2_mc.GetYaxis().SetTitleOffset(0.40)
  vFrame2_mc.GetYaxis().SetLabelSize(0.09)
  vFrame2_mc.GetXaxis().SetTitleSize(0.18)
  vFrame2_mc.GetXaxis().SetTitleOffset(0.90)
  vFrame2_mc.GetXaxis().SetLabelSize(0.15)
  ...
  line_mc = TLine(minX_mass,0,maxX_mass,0)
  line_mc.Draw("")
  p11_2_mc.RedrawAxis()
  line2_mc=TLine()
  line2_mc.DrawLine(p11_2_mc.GetUxmin(), p11_2_mc.GetUymax(), p11_2_mc.GetUxmax(), p11_2_mc.GetUymax())
  line2_mc.DrawLine(p11_2_mc.GetUxmax(), p11_2_mc.GetUymin(), p11_2_mc.GetUxmax(), p11_2_mc.GetUymax())
 
  ### Output files
  output_root_file_mc = "dijetFitResults_MC_%s.root" % (fileNameSuffix) 
  f_output_mc = TFile(output_root_file_mc,"RECREATE")
  f_output_mc.cd()
  g_mc.Write()
  ...
  c_fileName_mc = "MCandResiduals_%s.png" %(fileNameSuffix)
  c_mc.SaveAs(outputDir+"/"+c_fileName_mc)
  c_fileName_mc = "MCandResiduals_%s.pdf" %(fileNameSuffix)
  c_mc.SaveAs(outputDir+"/"+c_fileName_mc)
#================================================================================================================

def DrawFit(g,g_mc,M1Bkg, hist_fit_residual_vsMass, FunctionType, nPar,
            fileNameSuffix, chi2, ndof):
