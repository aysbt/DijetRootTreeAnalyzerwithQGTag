...
for f in fileNames:
  ...
  #standard
  tree.Project(h_allCuts.GetName(), var,'deltaETAjj<1.3 && mjj > '+str(minX_mass)+'&& QG1stJet >='+str(qgcut)+'&& QG2ndJet >='+str(qgcut))
  # blinded 4 TeV
...
if golden:
  chain.Project("h_dat", var,'deltaETAjj<1.3 && mjj > '+str(minX_mass)+'&& QG1stJet >='+str(qgcut)+'&& QG2ndJet >='+str(qgcut)+' && run >= '+ str(runMin) + '&& run <= ' + str(runMax) +' && PassJSON==1')
else:
  chain.Project("h_dat", var,'deltaETAjj<1.3 && mjj > '+str(minX_mass)+'&& QG1stJet >='+str(qgcut)+'&& QG2ndJet >='+str(qgcut)+' && run >= '+ str(runMin) + ' && run <= ' + str(runMax) )
