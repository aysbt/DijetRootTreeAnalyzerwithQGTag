...
//abat
 //   TH1F *h_dijetmass_1GeV = new TH1F ("h_DijetMass_onebin","",1400,0,14000);
   // h_dijetmass_1GeV->Sumw2();
...
//~//
   ...
   //for (Long64_t jentry=0; jentry<2000;jentry++) {
     ...
     ///Stuff to be done for every event
      //abat//qgLDAK4->size
     size_t no_jets_ak4=qgLDAK4->size();
	   ...
	   if(fabs(jetEtaAK4->at(sortedJetIdx[0])) < getPreCutValue1("jetFidRegion") 
	      && (jecFactors[sortedJetIdx[0]]/jetJecAK4->at(sortedJetIdx[0]))*jetPtAK4->at(sortedJetIdx[sortedJetIdx[0]]) > getPreCutValue1("pt0Cut"))
	     {
		  ...
		  && (jecFactors[sortedJetIdx[1]]/jetJecAK4->at(sortedJetIdx[1]))*jetPtAK4->at(sortedJetIdx[1]) > getPreCutValue1("pt1Cut") )
                {
                if ((qgLDAK4->at(sortedJetIdx[0])>getPreCutValue1("qgRegion")&& qgLDAK4->at(sortedJetIdx[1])<getPreCutValue1("qgRegion"))||(qgLDAK4->at(sortedJetIdx[0])<getPreCutValue1("qgRegion")&& qgLDAK4->at(sortedJetIdx[1])>getPreCutValue1("qgRegion")))
   ...
   //fillVariableWithValue ( "PassJSON", passJSON (runNo, lumi, isData));
     ...
     if( AK4jets.size() >=1 ){
       ...
       fillVariableWithValue( "photonMult_j1", phoMultAK4->at(sortedJetIdx[0]));
        //abat
       fillVariableWithValue( "QG1stJet_AK4", qgLDAK4->at(0));
       fillVariableWithValue("qgaxis2AK4_j1",qgaxis2AK4->at(0));
       fillVariableWithValue("qgptDAK4_j1",qgptDAK4->at(0));
       fillVariableWithValue("qgmultAK4_j1",qgmultAK4->at(0));
       fillVariableWithValue("partonAK4_j1",partonAK4->at(0));    
       //~// 
}
     if( AK4jets.size() >=2 ){
       ...
       //abat
       fillVariableWithValue( "QG2ndJet_AK4", qgLDAK4->at(1));
       fillVariableWithValue("qgaxis2AK4_j2",qgaxis2AK4->at(1));
       fillVariableWithValue("qgptDAK4_j2",qgptDAK4->at(1));
       fillVariableWithValue("qgmultAK4_j2",qgmultAK4->at(1));
       fillVariableWithValue("partonAK4_j2",partonAK4->at(1));
       //~//
    }
	 ...
	 //no cuts on these variables, just to store in output
         ...
         //abat
         fillVariableWithValue( "QG1stJet", qgLDAK4->at(0));
         fillVariableWithValue("qgaxis2_wide_j1",qgaxis2AK4->at(0));
         fillVariableWithValue("qgptD_wide_j1",qgptDAK4->at(0));
         fillVariableWithValue("qgmult_wide_j1",qgmultAK4->at(0));
         fillVariableWithValue("parton_wide_j1",partonAK4->at(0));
         //~//       
	 ...
	 //    //std::cout << " INV MASS FROM NTUPLE CA8 " << mjjCA8 << std::endl;
          ...
          //abat
         fillVariableWithValue( "QG2ndJet", qgLDAK4->at(1));
         fillVariableWithValue("qgaxis2_wide_j2",qgaxis2AK4->at(1));
         fillVariableWithValue("qgptD_wide_j2",qgptDAK4->at(1));
         fillVariableWithValue("qgmult_wide_j2",qgmultAK4->at(1));
         fillVariableWithValue("parton_wide_j2",partonAK4->at(1));        
         //~//
}       
	 ...
	 && getVariableValue("deltaETAjj") <  getPreCutValue1("DetaJJforTrig") ){
       ...
       //abat
       //h_dijetmass->Fill(MJJWide);
       //h_dijetmass_1GeV->Fill(MJJWide); 
       //~//
 ...
 /*  TH1F * h_QG1stJet = new TH1F ("h_QG1stJet","", getHistoNBins("QG1stJet"), getHistoMin("QG1stJet"), getHistoMax("QG1stJet"));
   h_QG1stJet->Add( & getHisto_noCuts_or_skim("QG1stJet"));
   h_QG1stJet->Write();
  TH1F * h_QG2ndJet = new TH1F ("h_QG2ndJet","", getHistoNBins("QG2ndJet"), getHistoMin("QG2ndJet"), getHistoMax("QG2ndJet"));
   h_QG2ndJet->Add( & getHisto_noCuts_or_skim("QG2ndJet"));
   h_QG2ndJet->Write();
 TH1F * h_qgaxis2_wide_j1 = new TH1F ("qgaxis2_wide_j1","", getHistoNBins("qgaxis2_wide_j1"), getHistoMin("qgaxis2_wide_j1"), getHistoMax("qgaxis2_wide_j1"));
   h_qgaxis2_wide_j1->Add( & getHisto_noCuts_or_skim("qgaxis2_wide_j1"));
   h_qgaxis2_wide_j1->Write();
 TH1F * h_qgaxis2_wide_j2 = new TH1F ("qgaxis2_wide_j2","", getHistoNBins("qgaxis2_wide_j2"), getHistoMin("qgaxis2_wide_j2"), getHistoMax("qgaxis2_wide_j2"));
   h_qgaxis2_wide_j2->Add( & getHisto_noCuts_or_skim("qgaxis2_wide_j2"));
   h_qgaxis2_wide_j2->Write();
 TH1F * h_qgptD_wide_j1 = new TH1F ("qgptD_wide_j1","", getHistoNBins("qgptD_wide_j1"), getHistoMin("qgptD_wide_j1"), getHistoMax("qgptD_wide_j1"));
   h_qgptD_wide_j1->Add( & getHisto_noCuts_or_skim("qgptD_wide_j1"));
   h_qgptD_wide_j1->Write();
 TH1F * h_qgptD_wide_j2 = new TH1F ("qgptD_wide_j2","", getHistoNBins("qgptD_wide_j2"), getHistoMin("qgptD_wide_j2"), getHistoMax("qgptD_wide_j2"));
   h_qgptD_wide_j2->Add( & getHisto_noCuts_or_skim("qgptD_wide_j2"));
   h_qgptD_wide_j2->Write();
 TH1F * h_qgmult_wide_j1 = new TH1F ("qgmult_wide_j1","", getHistoNBins("qgmult_wide_j1"), getHistoMin("qgmult_wide_j1"), getHistoMax("qgmult_wide_j1"));
   h_qgmult_wide_j1->Add( & getHisto_noCuts_or_skim("qgmult_wide_j1"));
   h_qgmult_wide_j1->Write();
 TH1F * h_qgmult_wide_j2 = new TH1F ("qgmult_wide_j2","", getHistoNBins("qgmult_wide_j2"), getHistoMin("qgmult_wide_j2"), getHistoMax("qgmult_wide_j2"));
   h_qgmult_wide_j2->Add( & getHisto_noCuts_or_skim("qgmult_wide_j2"));
   h_qgmult_wide_j2->Write();
